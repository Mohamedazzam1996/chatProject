package com.example.mazzam.chatproject.Base;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public void saveString(String key,String value){
        ...
        SharedPreferences.Editor editor=getSharedPreferences("chatPrefrences",MODE_PRIVATE).edit();
        editor.putString(key,value);
        editor.apply();
    }
    public String getString(String key){
        SharedPreferences sharedPreferences= getSharedPreferences("chatPrefrences",MODE_PRIVATE);
